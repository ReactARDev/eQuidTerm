  ...
  render() {
    ...
    if (url === '') {
        ...
        <div className="HomePage__black">
          <div className="so-back">
            <div className="HomePage__lead">
              ...
              <p className="HomePage__lead__summary">eQuid is an <a href="https://github.com/stellarterm/stellarterm" target="_blank" rel="nofollow noopener noreferrer">open source</a> client for the <a href="https://www.stellar.org/" target="_blank" rel="nofollow noopener noreferrer">Stellar network</a>. <br />Send, receive, and <a href="#exchange">trade</a> assets on the Stellar network easily with eQuid.</p>
            ...
            <div className="island__sub">
              <div className="island__sub__division">
                <div className="HomePage__sideBlurb">
                  <p>eQuid is just a client that can be used to access the Stellar Decentralized Exchange. Neither eQuid nor the developers of it are involved with operating the Stellar network.</p>
                  <p>eQuid is developed by Iris Li, a former employee of the Stellar Development Foundation. The project is independent of the Stellar Development Foundation.</p>
                </div>
              </div>
              <div className="island__sub__division">
                <div className="HomePage__sideBlurb">
                  <p>eQuid is open source software. To support the project, please <a href="https://github.com/stellarterm/stellarterm" target="_blank" rel="nofollow noopener noreferrer">star the project on GitHub</a>.</p>
      ...
      body = <Generic title="Privacy Policy">
        ...
        <p>eQuid does track your actions on this client.</p>
        <p>eQuid does not store cookies and the website does not contain any analytics scripts.</p>
        <p>eQuid developers never see your private keys.</p>
        <p>However, eQuid.com is hosted on GitHub, AWS, and Cloudflare infrastructure. They may and do have their own tracking systems on their servers. Those services have their own privacy policies and they are not covered by this privacy policy.</p>
        <p>While eQuid does not track you, this does not mean your actions are private. Take note of other privacy issues that may affect you:</p>
        <ul className="privacy__ul">
          ...
          <li>The eQuid website might be compromised.</li>
        </ul>
      </Generic>
      ...
      if (urlParts.length === 3) {
        ...
        if (this.d.orderbook.data.ready) {
          ...
          let baseBuying = new StellarSdk.Asset('EQD', 'GCGEQJR3E5BVMQYSNCHPO6NPP3KOT4VVZHIOLSRSNLE2GFY7EWVSLLTN');
