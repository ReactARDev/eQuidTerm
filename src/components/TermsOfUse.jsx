    ...
    return <div>
      <Generic>
        ...
        <div>
          ...
          <br />
          <br />
          <h3>2. The Stellar network (separate from eQuid)</h3>
          eQuid is <strong>not an exchange</strong>. eQuid is <strong>only a user interface</strong> to Stellar and does not operate the <a href="https://www.stellar.org/" target="_blank" rel="nofollow noopener noreferrer">Stellar network</a>. eQuid is unable to control the actions of others on the <a href="https://www.stellar.org/" target="_blank" rel="nofollow noopener noreferrer">Stellar network</a>. When using eQuid, you are directly communicating with the Horizon Stellar API operated by Stellar Development Foundation. Transactions on the <a href="https://www.stellar.org/" target="_blank" rel="nofollow noopener noreferrer">Stellar network</a> are <strong>irreversible</strong>.
          <br />
          <br />
          <h3>3. Privacy</h3>
          ...
          <br />
          <br />
          <h3>4. eQuid does not endorse anything</h3>
          eQuid <strong>does NOT endorse ANY</strong> asset on the <a href="https://www.stellar.org/" target="_blank" rel="nofollow noopener noreferrer">Stellar network</a>. Asset "listings" on eQuid are NOT endorsements. eQuid is a software client ONLY and does NOT conduct any independent diligence or review of any asset. Stellar is an open system meaning that scams and market manipulators may exist. Prices shown on eQuid are for informational purposes and do not imply that they can actually be redeemed for a certain price.
          <br />
          <br />
          ...
          eQuid is open source software licensed under the <a href="https://www.apache.org/licenses/LICENSE-2.0" target="_blank" rel="nofollow noopener noreferrer">Apache-2.0 license</a>. It is provided fre of charge and on an <strong>"AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND</strong>.
          <br />
          <br />
