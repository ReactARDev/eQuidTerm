  ...
  render() {
    ...
    if (state === 'out') {
      ...
      if (!d.session.inflationDone) {
        ...
        return <div>
          <Generic>
            <h2 className="Session__welcomeTitle">Welcome to eQuid!</h2>
            ...
            <div className="Session__inflation">
              eQuid is free open source software. eQuid does not ask for donations, but instead, asks for inflation votes. The Stellar network rewards accounts that receive many votes through an "<a href="https://www.stellar.org/developers/guides/concepts/inflation.html" target="_blank" rel="nofollow noopener noreferrer">inflation system</a>". It is free to vote for eQuid and only requires a vote transaction (0.00001 XLM). Note: other wallets may do this without your permission, so if you use another wallet and they tamper with your account, this message may show up again.
              <br />
              <br />
              By pressing "Accept and Continue", your account will vote for the eQuid inflation account. Thank you for your support!{currentVoteNote}
      ...
      if (part1 === undefined) {
        content = <ErrorBoundary>
          ...
          <Generic noTopPadding>
            ...
            <p>In the Stellar network, funds exist on the network and can only be moved by whoever has the secret key. This means that your secret key is extremely sensitive, and whoever has access to it can move the funds. However, money is <strong>NOT</strong> actually <em>"inside"</em> eQuid. eQuid is just a helpful tool that helps you use your secret key to make transactions.</p>
