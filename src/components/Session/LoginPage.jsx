  ...
  render() {
    ...
    if (this.state.newKeypair !== null) {
      newKeypairDetails = <div className="LoginPage__generatedNote">
        <p><strong>Keep your key secure. This secret key will only be showed to you once. eQuid does not save it and will not be able to help you recover it if lost.</strong></p>
    ...
    let acceptTerms = <label className="s-inputGroup LoginPage__accept">
        ...
        <span className="LoginPage__accept__label">I accept the <a href="#terms-of-use" className="LoginPage__accept__link">Terms of Use</a>, understand the risks associated with cryptocurrencies, and know that eQuid does not issue or endorse any asset on the Stellar network.</span>
      </label>
        ...
        <div className="LoginPage__greenBox">
          ...
          <div className="LoginPage__notes">
            ...
            <ul>
              ...
              <li>eQuid does not save your secret key. It is stored on your browser and will be deleted once the page is refreshed or exited.</li>
            </ul>
          </div>
        </div>
      </div>
